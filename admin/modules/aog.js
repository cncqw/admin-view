...
;layui.define(["table", "form"], function (t) {
    ...
    i.render({
        ...
        cols: [[
            ...
            {field: "label", title: "到货单号", minWidth: 100},
            {field: "title", title: "物流单号"},
            {field: "author", title: "物流公司"},
            {field: "uploadtime", title: "创建时间", sort: !0},
            {field: "status", title: "验收状态", templet: "#buttonTpl", minWidth: 80, align: "center"},
        ...
        text: "对不起，加载出现异常！"
    }), i.on("tool(bases-aog-list)", function (t) {
        var e = t.data;
        "del" === t.event ? layer.confirm("确定删除此文章？", function (e) {
            ...
            type: 2,
            title: "查看详情",
            content: "../../../views/app/bases/detail.html?id=" + e.id,
            maxmin: !0,
            area: ["1000px", "650px"],
            btn: ["确定", "关闭"],
            yes: function (e, i) {
        ...
        cols: [[
            {type: "numbers", fixed: "left"}, {field: "id", width: 100, title: "ID", sort: !0},
